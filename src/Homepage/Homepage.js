    ...
    <div className="Homepage">
      ...
      <div className="homepage-middle-text">
        ...
        <p className="homepage-summary">
          ...
          quick learner, curious and thrilled by new challenges.
        </p>
        <Tags
          skills={[
            'HTML 5',
      ...
      <section className="homepage-footer">
        ...
        <span className="footer-contact">
          ...
          <a className="mail" href="mailto:zoldan.rafael@gmail.com">
            <img className="mail-img" src="/assets/mail.svg" alt="mail" />
          </a>
        </span>
      </section>
    </div>
